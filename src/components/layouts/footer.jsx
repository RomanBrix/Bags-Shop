        ...
        <div className="footer forContainer">
            <div className="container">
                <ul>
                    ...
                    <li onClick={()=>{navigate('/return')}}>{translate.return}</li>
                    <li onClick={()=>{navigate('/terms')}}>{translate.terms}</li>
                    <li onClick={()=>{navigate('/delivery')}}>{translate.delivery}</li>
                    <li onClick={()=>{navigate('/contacts')}}>{translate.contacts}</li>
                    <li onClick={()=>{alert('insta')}}><Insta/></li>
                </ul>
            </div>
        </div>
    )
